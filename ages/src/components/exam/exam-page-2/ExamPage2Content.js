...
const ExamPage2Content = ({ lv2Urls, startTimer }) => {
  ...
  useEffect(() => {
    const fetchImages = async () => {
      const img1 = await fetchImage('lv2-1_page-0001.jpg');
      const img2 = await fetchImage('lv2-2_page-0001.jpg');
      setImg1(img1);
      setImg2(img2);
    };
...
export default ExamPage2Content;
