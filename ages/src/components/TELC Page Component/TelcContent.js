        ...
        <div className="row">
          <div className="col-md-6 mb-5">
            ...
            >
              ...
              <br />
              <p>
                Telc offers a wide range of language certificates from A1 to C2
                to help you demonstrate language ability in any situation. telc
                ...
                available, assessing language skills at two levels of
                competence. All telc examinations focus on using language for
                effective communication. Connecting with people around the
                world, understanding others, being understood, and using your
                skills confidently in real-life situations is the key to
